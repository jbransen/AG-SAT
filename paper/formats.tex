...
\newcommand{\agvarlinedowndown}[7]{ \draw[-,style=agdepstyle,#5] (#2.south) .. controls +(0,-#7) and +(0,-1) .. node[] {#6} (#3.south); }
\newcommand{\agvarlineupup}[7]{ \draw[-,style=agdepstyle,#5] (#2.north) .. controls +(0,#7) and +(0,1) .. node[] {#6} (#3.north); }
