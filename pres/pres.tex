...
\agendprod{0}{Bin}{lhs}{Tree}{19.733333333333334} %    
        ...
        \only<4>{
        \node[above=0mm of lhsIlab] {\scriptsize{\textcolor{red}{1}}};
        \node[above=0mm of lhsIvals] {\scriptsize{\textcolor{red}{7}}};
        \node[below=0mm of lIlab] {\scriptsize{\textcolor{red}{2}}};
        \node[below=0mm of lIvals] {\scriptsize{\textcolor{red}{10}}};
        \node[below=0mm of lSlab] {\scriptsize{\textcolor{red}{3}}};
        \node[below=0mm of lSvals] {\scriptsize{\textcolor{red}{11}}};
        \node[below=0mm of rIlab] {\scriptsize{\textcolor{red}{4}}};
        \node[below=0mm of rIvals] {\scriptsize{\textcolor{red}{8}}};
        \node[below=0mm of rSlab] {\scriptsize{\textcolor{red}{5}}};
        \node[below=0mm of rSvals] {\scriptsize{\textcolor{red}{9}}};
        \node[above=0mm of lhsSlab] {\scriptsize{\textcolor{red}{6}}};
        \node[above=0mm of lhsSvals] {\scriptsize{\textcolor{red}{12}}};
        }
        \only<5>{
        \node[above=0mm of lhsIlab] {\scriptsize{\textcolor{blue}{1}}};
